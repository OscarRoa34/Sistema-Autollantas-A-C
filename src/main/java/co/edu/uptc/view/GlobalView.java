...
public class GlobalView {
    ...
    public static Color ASIDE_BACKGROUND = new Color(223, 166, 31);
    public static Color HEADER_BACKGROUND = new Color(21, 20, 20);

    public static Color WELCOME_ROUND_BACKGROUND = new Color(44, 44, 44);

    public static Color ASIDE_BUTTONS_BACKGROUND = new Color(223, 166, 31);
    ...
    public static Color GENERAL_BACKGROUND = new Color(240, 240, 240);
    public static Color CARDS_BACKGROUND = new Color(247, 247, 247);
